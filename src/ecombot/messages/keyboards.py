...
class KeyboardMessageManager(BaseMessageManager):
    ...
    def _load_messages(self) -> None:
        ...
        en_messages = {
            ...
            "enabled": "Enabled",
            "disabled": "Disabled",
            "add_pickup_point": "➕ Add New Pickup Point",
            "view_addresses": "📋 View Addresses",
            "enable": "Enable ✅",
            "disable": "Disable ❌",
            "delete": "🗑️ Delete",
            "pickup_store": "Store",
            "pickup_locker": "Locker",
        ...
        es_messages = {
            ...
            "add_pickup_point": "➕ Agregar Punto de Recogida",
            "view_addresses": "📋 Ver Direcciones",
            "enable": "Habilitar ✅",
            "disable": "Deshabilitar ❌",
            "delete": "🗑️ Eliminar",
            "pickup_store": "Tienda",
            "pickup_locker": "Taquilla",
            "pickup_curbside": "Recogida en acera",
        ...
        ru_messages = {
            ...
            "enabled": "Включено",
            "disabled": "Выключено",
            "add_pickup_point": "➕ Добавить Пункт Выдачи",
            "view_addresses": "📋 Посмотреть Адреса",
            "enable": "Включить ✅",
            "disable": "Отключить ❌",
            "delete": "🗑️ Удалить",
            "pickup_store": "Магазин",
            "pickup_locker": "Постамат",
            "pickup_curbside": "Выдача на улице",
