...
class CatalogMessageManager(BaseMessageManager):
    ...
    def _load_messages(self) -> None:
        ...
        es_messages = {
            # Welcome and navigation
            "welcome_message": (
                "¡Bienvenido a nuestra tienda! Elige una categoría "
            ...
            "error_category_not_found": (
                "Lo siento, no se pudo encontrar esta categoría."
            ),
            "error_loading_catalog": (
                "Error al cargar el catálogo. Por favor, inténtalo de nuevo."
            ),
        }
        ...
        ru_messages = {
            # Welcome and navigation
            "welcome_message": (
                "Добро пожаловать в наш магазин! Выберите категорию "
            ...
            "error_loading_catalog": (
                "Ошибка загрузки каталога. Пожалуйста, попробуйте снова."
            ),
        }
