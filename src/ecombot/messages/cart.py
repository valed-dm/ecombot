    ...
    def _load_messages(self) -> None:
        ...
        en_messages = {
            ...
            "error_insufficient_stock": (
                "❌ Not enough stock available. Only {available} items left."
            ),
        }
        ...
        es_messages = {
            ...
            "error_cart_update_failed": (
                "Error al actualizar la visualización del carrito."
            ),
            "error_generic": "Ocurrió un error.",
            "error_out_of_stock": "❌ Lo siento, este producto está agotado.",
            "error_insufficient_stock": (
                "❌ Stock insuficiente. Solo quedan {available} artículos."
            ),
        }
        ...
        ru_messages = {
            ...
            "error_insufficient_stock": (
                "❌ Недостаточно товара на складе. Осталось только {available} шт."
            ),
        }
